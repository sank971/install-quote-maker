-- Tracks whether the installation is fully out of service, both for local diagnostic
-- reports and for tickets imported from the field-service tool.
...
-- Re-derive installation_stopped from equipment.state (or an explicit equipment.stopped
-- boolean) when importing a ticket from the field-service webhook.
...
begin
  ...
  insert into public.tickets(
    ...
    external_source, external_ref, installation_stopped
  ) values (
    ...
    'field_service', ticket->>'id', v_installation_stopped
  )
